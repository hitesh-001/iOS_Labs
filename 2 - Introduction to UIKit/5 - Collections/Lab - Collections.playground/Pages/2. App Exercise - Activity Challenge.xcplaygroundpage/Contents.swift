 ...
 */
var walking : [String] = ["challenge1", "challenge2"]
var running = ["challenge1","challenge2"]
...
if newArray.isEmpty{
    print("you have to commit a challenge")
} else if(newArray.count==1){
    print("The challenge you chose was \(newArray[0])")
}else{
