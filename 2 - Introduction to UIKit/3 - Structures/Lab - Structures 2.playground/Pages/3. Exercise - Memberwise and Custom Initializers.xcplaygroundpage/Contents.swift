...
var favoriteBook = Book(title: "Heartstopper", author: "someAuthor", pages: 900, price: 799.0)
print(" I recenyl recieved \(favoriteBook.title) by \(favoriteBook.author) it is of \(favoriteBook.pages) and costed me around \(favoriteBook.price)")
/*:
...
var hp = Laptop(yearPurchased: 2019)
var lenovo = Laptop(yearPurchased: 2018)
