...
var palak = User(name: "Palak", age: 20, height: 155, weight: 53.0, activtyLevel: 9)
print("User name  \(palak.name) of age \(palak.age) and height \(palak.height) and weight \(palak.weight) is at activity level \(palak.activtyLevel)")
/*:
