...
let somePlace = GPS(latitude: 51.5514004, longitude: 0.125226)
...
var favoriteBook = Book(title: "Ikigai", author: "someAuthor", pages: 200, price: 349.0)
...
var firstInitializer = Laptop(yearPurchased: 2023)
var secondInitializer = Laptop(yearPurchased: 2024)
/*:
...
struct Height{
    ...
    init(height : Double){
        ...
        self.heightInCentimetres = heightInInches*2.54
        
    }
    init(heightcm: Double){
        //var otherHeight =  heightInInches * 2.54
        self.heightInCentimetres = heightcm
        self.heightInInches = heightInCentimetres/2.54
        
    }
}

var ans1 = Height(height: 65)
print(ans1)
var ans2 = Height(heightcm : 65)
print(ans2)
...
var someonesHeight = Height(height: 65)
